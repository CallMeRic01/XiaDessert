...
CREATE TABLE `customer` (
  ...
  `cust_num` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cust_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cust_dob` date DEFAULT NULL,
  `cust_loyalP` int DEFAULT NULL,
  PRIMARY KEY (`cust_id`)
...
INSERT INTO `customer` VALUES (1,'1','123123','ww@gmail.com','2024-08-07',27),(2,'erloca','0112912018247','ee@gmail.com','2024-08-22',8),(3,'er','01111111','ericlim0110@gmail.com','2024-10-01',22);
